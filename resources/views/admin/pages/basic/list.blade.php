        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title float-left mt-2">Список страниц</h4>
                    <a href="/admin/basic/create"
                        ...
                        <table id="default_order" class="table table-striped table-bordered display"
                            ...
                            @foreach($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        <button class="copytext btn btn-primary"
                                                data-text="/pages/{{$item->slug}}"><i
                                                class="mdi mdi-content-copy"></i></button>
                                    </td>
                                    <td>{{date('d.m.Y', strtotime($item->created_at))}}</td>
                                    <td>
                                        <a href="/admin/basic/edit/{{$item->id}}/ru"
                                           class="btn btn-success waves-effect waves-light"><i
                                                class="fas fa-edit"></i></a>
                                        <a href="/admin/basic/delete/{{$item->id}}"
