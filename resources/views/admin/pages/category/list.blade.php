        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title float-left mt-2">Список категорий</h4>
                                ...
                                <li class="dd-item dd3-item" data-id="{{$item->id}}">
                                    ...
                                    <div class="dd3-content">
                                        ...
                                        <div class="btn-group float-right">
                                            <a href="/admin/category/edit/{{$item->id}}/ru"
                                            ...
                                            @foreach($item->children as $item2)
                                                <li class="dd-item dd3-item" data-id="{{$item2->id}}">
                                                    ...
                                                    <div class="dd3-content">
                                                        {{$item2->title}}
                                                        <div class="btn-group float-right">
                                                            <a href="/admin/category/edit/{{$item2->id}}/ru"
                                                               class="badge badge-info waves-effect waves-light"><i
                                                                    class="fas fa-edit"></i></a>
                                                            <a href="/admin/category/delete/{{$item2->id}}"
                                                               class="ml-1 badge badge-danger waves-effect waves-light"><i
                                                                    class="fas fa-trash-alt"></i></a>
                                                        </div>
                                                    </div>
                                                            ...
                                                            @foreach($item2->children as $item3)
                                                                <li class="dd-item dd3-item" data-id="{{$item3->id}}">
                                                                    ...
                                                                    <div class="dd3-content">
                                                                        {{$item3->title}}
                                                                        <div class="btn-group float-right">
                                                                            <a href="/admin/category/edit/{{$item3->id}}/ru"
                                                                               class="badge badge-info waves-effect waves-light"><i
                                                                                    class="fas fa-edit"></i></a>
                                                                            <a href="/admin/category/delete/{{$item3->id}}"
                                                                               class="ml-1 badge badge-danger waves-effect waves-light"><i
                                                                                    class="fas fa-trash-alt"></i></a>
                                                                        </div>
                                                                    </div>
