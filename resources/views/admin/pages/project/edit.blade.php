...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Изменение проекта</h4>
                    <ul class="nav nav-tabs mb-3">
                        @foreach(\Config::get('app.locales') as $lang)
                            <li class="nav-item">
                                <a href="/admin/project/edit/{{$id}}/{{$lang}}"
                    ...
                    <form class="form-material mt-4" method="post" enctype="multipart/form-data"
                          action="/admin/project/edit/{{$id}}/{{$l}}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="service_id" id="service_id" class="form-control form-control-line">
                                @foreach($categories as $item)
                                    <option @if($data->service_id == $item->id) selected
