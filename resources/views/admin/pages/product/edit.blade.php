...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Изменение продукта</h4>
                    <ul class="nav nav-tabs mb-3">
                        @foreach(\Config::get('app.locales') as $lang)
                            <li class="nav-item">
                                <a href="/admin/product/edit/{{$id}}/{{$lang}}"
                    ...
                    <form class="form-material mt-4" method="post" enctype="multipart/form-data"
                          action="/admin/product/edit/{{$id}}/{{$l}}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_id" id="category_id" class="form-control form-control-line">
                                @foreach($categories as $item)
                                    <option @if($data->category_id == $item->id) selected
                        ...
                        <div class="form-group">
                            <label for="full">Характеристика</label>
                            <textarea rows="3" id="full" name="full"
                                      class="form-control form-control-line">{!! $data->full !!}</textarea>
                        </div>
                        <div class="row">
